              ...
              <div className="relative h-56 overflow-hidden">
                ...
                {offer.savings && (
                  <div className="absolute top-4 right-4 bg-red-500 text-white text-xs font-bold px-3 py-1.5 rounded-full">
                    Save KES {offer.savings.toLocaleString()}
                  </div>
                )}
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <span className="text-xs text-gold font-medium uppercase tracking-widest">{offer.tag}</span>
                  </div>
                ...
                <div className="bg-cream rounded-xl p-4 mb-5">
                  ...
                  <div className="grid grid-cols-2 gap-1">
                    {offer.includes.map(item => (
                      <div key={item} className="flex items-start gap-1.5 text-xs text-muted">
