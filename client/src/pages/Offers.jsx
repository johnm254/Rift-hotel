...
// Static fallback offers shown when no dynamic packages exist
const staticOffers = [
  {
    ...
    price: 185000, originalPrice: 220000, savings: 35000, roomId: 'room-6',
  ...
  },
  {
    ...
    price: 210000, originalPrice: 260000, savings: 50000, roomId: 'room-3',
  ...
  },
  {
    ...
    price: 52000, originalPrice: 65000, savings: 13000, roomId: 'room-4',
  ...
  },
  {
    ...
    price: 89000, originalPrice: 110000, savings: 21000, roomId: 'room-5',
...
export default function Offers() {
  ...
  // Use dynamic packages if available, otherwise fall back to static
  ...
  return (
    <div>
      ...
      <section className="hero-gradient py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-cream/60 max-w-lg mx-auto">
            Curated experiences designed to make your stay extraordinary — at exceptional value.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {isLoading ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[1,2,3,4].map(i => (
              <div key={i} className="bg-white rounded-2xl overflow-hidden border border-cream-dark animate-pulse">
                <div className="h-56 bg-cream-dark" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {offers.map(offer => {
              const savings = offer.originalPrice && offer.price ? offer.originalPrice - offer.price : offer.savings;
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="text-right">
                        ...
                        {offer.originalPrice && (
                          <div className="text-xs text-muted line-through">KES {offer.originalPrice?.toLocaleString()}</div>
                        )}
                      </div>
                    </div>
      ...
      <section className="bg-navy py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-cream/60 mb-8">
            Planning a corporate retreat, anniversary, birthday, or group booking? Our events team will craft a bespoke package just for you.
          </p>
    ...
    description: 'Begin your forever in absolute luxury. This package includes our signature Honeymoon Retreat suite, champagne on arrival, couples spa treatment, private candlelit dinner, and daily breakfast in bed.',
    price: 185000,
  ...
  },
  {
    ...
    subtitle: '4 nights · up to 6 guests',
    description: 'Create memories that last a lifetime. The Safari Family Suite with a dedicated kids play area, daily activities, family dining, and a guided Nairobi National Park safari.',
    price: 210000,
  ...
  },
  {
    ...
    subtitle: '2 nights · 1–2 guests',
    description: 'Stay productive and comfortable. Our Executive Business Room with high-speed WiFi, meeting room access, airport transfers, and a curated business amenity kit.',
    price: 52000,
    originalPrice: 65000,
    savings: 13000,
    roomId: 'room-4',
  ...
  },
  {
    ...
    description: 'Escape the city for a perfect weekend. Enjoy our Poolside Bungalow with direct pool access, sunset cocktails, a spa credit, and a romantic dinner for two.',
    price: 89000,
  ...
  },
  {
    ...
    subtitle: '7+ nights · any room',
    description: 'Planning a longer visit? Enjoy 20% off our best available rate for stays of 7 nights or more, plus complimentary laundry, a welcome dinner, and a dedicated concierge.',
    price: null,
    originalPrice: null,
    savings: null,
    roomId: null,
  ...
  },
  {
    ...
    subtitle: '3 nights · 1–2 guests',
    description: 'Completely disconnect and recharge. Three nights in our Deluxe Garden View room with daily spa treatments, yoga sessions, healthy dining, and a digital detox programme.',
    price: 145000,
